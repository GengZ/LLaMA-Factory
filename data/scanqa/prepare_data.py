...
if __name__ == "__main__":
    ...
    dataset = iter_hf_parquet(
        "/home/geng/data/verl/scanqa_images_16_keyframes_120_non_keyframes_504x504/train.parquet", 
        split="train")
    results = []
    for row in tqdm(dataset):
        results.append(prepare_messages(row))
    with open("../scanqa_images_16_keyframes_120_non_keyframes_504x504_train.json", "w") as f:
        for result in results:
           json.dump(result, f)